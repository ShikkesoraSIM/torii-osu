...
namespace osu.Game.Localisation
{
    public static class GraphicsSettingsStrings
    {
        ...
        /// <summary>
        /// "Minimise Torii when switching to another app"
        /// </summary>
        public static LocalisableString MinimiseOnFocusLoss => new TranslatableString(getKey(@"minimise_on_focus_loss"), @"Minimise Torii when switching to another app");
