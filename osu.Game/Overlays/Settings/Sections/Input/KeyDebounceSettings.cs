...
{
    /// <summary>
    /// Torii: anti-chatter key debounce. Filters the spurious double-taps that
    /// rapid-trigger / hall-effect keyboards and worn mechanical switches produce,
    /// by dropping a gameplay-key re-press that lands within the threshold of that
    /// key's last release. Gameplay keys only, live play only (never replays).
    /// </summary>
