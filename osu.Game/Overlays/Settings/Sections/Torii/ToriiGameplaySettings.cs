...
{
    /// <summary>
    /// Torii-specific gameplay-flow tweaks. Currently houses the long-attempt
    /// retry/quit confirmation toggle; intended as the home for any future
    /// "modify how the gameplay screens behave" preferences so they don't
    /// pollute Interface (visuals) or Server (networking).
    /// </summary>
