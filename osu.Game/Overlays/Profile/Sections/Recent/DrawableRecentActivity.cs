        ...
        private void createMessage()
        {
            switch (activity.Type)
            {
                ...
                case RecentActivityType.UserSupportAgain:
                    addUserLink();
                    addText(" has once again chosen to support Torii - thanks for your generosity!");
                    break;

                case RecentActivityType.UserSupportFirst:
                    addUserLink();
                    addText(" has become a Torii supporter - thanks for your generosity!");
                    break;

                case RecentActivityType.UserSupportGift:
                    addUserLink();
                    addText(" has received the gift of Torii supporter!");
                    break;
