...
namespace osu.Game
{
    ...
    public partial class OsuGame : OsuGameBase, IKeyBindingHandler<GlobalAction>, ILocalUserPlayInfo, IPerformFromScreenRunner, IOverlayManager, ILinkHandler
    {
        ...
        protected override void LoadComplete()
        {
            ...
            loadComponentSingleFile(news = new NewsOverlay(), overlayContent.Add, false);
            ...
            loadComponentSingleFile(new osu.Game.Overlays.Cosmetics.CosmeticStoreOverlay(), overlayContent.Add, false);
            ...
            var singleDisplayOverlays = new OverlayContainer[] { chatOverlay, dashboard, beatmapListing, rankingsOverlay };
