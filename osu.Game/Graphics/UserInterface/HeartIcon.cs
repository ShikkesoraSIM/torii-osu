...
{
    /// <summary>
    /// A heart icon that switches between an outline (inactive) and a filled pink (active)
    /// state with a pop animation, plus an optional particle burst when transitioning to active.
    /// Used wherever a "favourite" affordance is shown — beatmap favourite button, pinned-skin
    /// indicator, etc.
    /// </summary>
