...
namespace osu.Game.Graphics.Cursor
{
    ...
    public enum MenuCursorStyle
    {
        ...
        /// </summary>
        [LocalisableDescription(typeof(UserInterfaceStrings), nameof(UserInterfaceStrings.MenuCursorStyleLazerDefault))]
        LazerDefault,
        ...
        /// active skin changes.
        /// </summary>
        [LocalisableDescription(typeof(UserInterfaceStrings), nameof(UserInterfaceStrings.MenuCursorStyleSkinCursor))]
        SkinCursor,
        ...
        /// </summary>
        [LocalisableDescription(typeof(UserInterfaceStrings), nameof(UserInterfaceStrings.MenuCursorStyleToriiCursor))]
        ToriiCursor,
    }
}
